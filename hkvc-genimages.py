...
s128a=pygame.Surface((128,128), pygame.SRCALPHA)
...
def gen_image(s, text, fileName, fillColor=(128,128,128,128)):
    print(text, fileName)
...
for control in controls:
    ...
    gen_image(s64a, control, fileName, fillColor=(128,128,128,64))
